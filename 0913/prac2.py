...
# 設定不同推播目標
TARGET_USER_ID = 8652886039               # 個人 (正整數，用戶需先私訊過 Bot)
TARGET_GROUP_ID = "-1004330102800"         # 群組 (負整數，Bot 需在群組內)
TARGET_CHANNEL = "-1004408821186"     # 頻道 Chat ID (Bot 需為管理員)
